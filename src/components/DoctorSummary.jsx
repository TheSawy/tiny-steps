...
import { generateId, getBabyAgeWeeks, getBabyAgeDays, formatAge, formatDuration, formatTime, formatDate, formatDateFull, getTimeSince, getTodayEvents, getLastEvent, getAgeRecommendations, toDateKey } from "../utils/helpers.js";
import { detectPatterns } from "../utils/patterns.js";
import { VACCINATION_SCHEDULE_BASE, WHO_MILESTONES } from "../data/constants.js";
...
// ============================================================
export const DoctorSummary = ({ state, onAddNote, onAddContextNote }) => {
